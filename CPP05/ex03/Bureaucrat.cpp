...
void Bureaucrat::executeForm(Form const& form){
    try
    {
   	...
   	catch (Form::IsNotSigned &ex)
	{
		std::cout << _name << " couldn't execute " << "form " << form.getName() << " because it isn't signed!" << std::endl;
	}
	catch (Form::GradeTooLowException &ex)
	{
		std::cout << _name << " couldn't execute " << "form " << form.getName() << " because this grade is too low!" << std::endl;
	}
